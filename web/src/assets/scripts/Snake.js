...
export class Snake extends GameObject {
    constructor(info, gamemap) {
        ...
        this.status = "stop";   //  stop表示静止，move表示正在移动，die表示死亡
        ...
        if(this.id === 1) this.eye_direction = 2;   //  左下角的蛇初始状态为蛇头朝上，右上角的蛇朝下
        
        this.eye_dx = [  //  蛇的眼镜不同方向的x偏移量
            [-1, 1],
            [1, 1],
            [1, -1],
            [-1, -1],
        ];
        this.eye_dy = [  //  蛇的眼镜不同方向的x偏移量
            [-1, -1],
            [-1, 1],
            [1, 1],
            [1, -1],
    ...
    render() {
        ...
        for(let i = 1; i < this.cells.length; i ++ ) {  //  通过矩阵填充美化蛇的身体
